...
// filter function takes in 3 parameters and returns company info based off those parameters
...
//these are error handlers oen for max/min constraint and the other for if query returns no answers
    ...
    if (!companyFilter) throw NotFoundError('No company matches this query')
